...
{
public:
    Panel(enumPanelType type, enumPanelOrientation orientation, int nPinN, int nPinE, int nPinS, int nPinW)
        : m_orientation(orientation), m_sensorN(nPinN), m_sensorE(nPinE), m_sensorS(nPinS), m_sensorW(nPinW)
    {}
